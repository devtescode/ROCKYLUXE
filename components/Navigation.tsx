      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link href="/admin" className="px-4 py-2 bg-primary text-primary-foreground rounded hover:opacity-90 transition-opacity">
              Admin
            </Link>
          </div>
        ...
        {isOpen && (
          <div className="md:hidden pb-4 space-y-4 border-t border-border">
            ...
            <Link href="/admin" className="block px-4 py-2 bg-primary text-primary-foreground rounded hover:opacity-90">
              Admin
            </Link>
          </div>
        )}
