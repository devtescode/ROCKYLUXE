        ...
        <div className="p-6 space-y-6">
          ...
          <div className="relative bg-secondary rounded-xl overflow-hidden h-96">
            <img
              ...
              alt={product.name}
              className={`object-cover w-full h-full transition-opacity duration-150 ${isAnimating ? 'opacity-50' : 'opacity-100'
                }`}
            />
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className={`px-4 py-2 rounded-full text-sm font-semibold ${product.category === 'In Stock'
            ...
            {/* Description */}
            <p className="text-foreground text-lg leading-relaxed">Description:- {product.description}</p>

            {/* Features */}
            {/* <div className="grid grid-cols-2 gap-4 p-4 bg-secondary rounded-lg">
              <div>
                <p className="text-sm text-muted-foreground mb-1">Material</p>
                <p className="font-semibold text-foreground">Premium Gold & Diamo</p>
              </div>
              <div>
